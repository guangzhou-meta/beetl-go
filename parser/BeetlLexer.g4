...
@lexer::members {
	func (b *BeetlLexer) notifyListeners(e antlr.LexerNoViableAltException) {
        text := b.GetInputStream().GetText(b.TokenStartCharIndex, b.GetInputStream().Index())
        b.GetErrorListenerDispatch().SyntaxError(b, nil, b.TokenStartLine, b.TokenStartColumn, text, e)
    }
}
